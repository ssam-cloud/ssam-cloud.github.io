---
layout: post
title: "pydeck : Python에서 deck.gl 사용하기"
subtitle: "pydeck :l using deck.gl in python"
categories: data
tags: mobility
comments: true
---
...
### Example Code
- 공식 홈페이지에서 제공하는 예시
	- 단 r.to_html을 r.show()로 바꿈(노트북에서 바로 보이도록 하기 위해)
...
### Ipywidget을 사용해 Interactive 시각화
- 사용 방식
